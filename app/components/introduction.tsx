            ...
            <div className="z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center max-w-md">
                    ...
                    <p className="mx-auto mb-2 text-xl md:text-xl md:mx-0 md:mb-8">
                        Como Programador Full Stack , me dedico a desarrollar soluciones
                        de Software teniendo en cuenta el ciclo de vida y las dimensiones del mismo.
                        Me gusta combinar diseño y funcionalidad para crear experiencias digitales impactantes y accesibles.
                    </p>
